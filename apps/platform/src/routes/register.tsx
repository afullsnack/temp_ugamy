...
function RouteComponent() {
    return <div className='relative bg-white w-full min-h-screen flex items-center justify-center overflow-hidden'>
        ...
        <div className='min-h-screen h-fit container flex flex-col md:flex-row md:items-start justify-center gap-x-3 gap-y-5 mx-auto'>
            <WelcomeScreen />
            <SignupForm />
        </div>
    </div>
