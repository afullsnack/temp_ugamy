...
const options = {
  ...
  trustedOrigins: ["*", "http://localhost:3000", "localhost:3000", "localhost", "http://localhost:3001", "http://localhost:3002", "https://dashboard.ugamy.io", "https://staging.ugamy.io", "https://ugamy.io", "https://www.ugamy.io"],
  advanced: {
    cookies: {
      session_token: {
        attributes: {
